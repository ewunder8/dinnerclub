  ...
  return (
    <main className="min-h-screen bg-snow">
      <nav className="bg-slate px-4 py-4 flex items-center gap-3">
        <a href="/dashboard" className="inline-flex items-center justify-center border border-white/20 hover:bg-white/10 transition-colors text-white w-9 h-9 rounded-full text-lg leading-none shrink-0">←</a>
        <h1 className="flex-1 min-w-0 font-sans text-base font-bold text-white text-center leading-tight">{displayName}</h1>
