    ...
    >
      ...
      <div>
        <label className="block text-sm font-semibold text-charcoal mb-1">
          Date & time <span className="text-clay">*</span>
        </label>
        <input
          type="datetime-local"
          value={datetime}
          ...
          min={minDatetime}
          required
          className="w-full bg-warm-white border border-black/10 rounded-xl px-4 py-3 text-charcoal focus:outline-none focus:border-clay transition-colors"
        />
      </div>
      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="w-10 h-10 rounded-xl bg-black/5 text-charcoal font-bold hover:bg-black/10 disabled:opacity-30 transition-colors text-lg"
          >
            −
          </button>
          <span className="font-bold text-xl text-charcoal w-6 text-center">
            {partySize}
          </span>
          <button
            type="button"
      ...
      <div>
        <label className="block text-sm font-semibold text-charcoal mb-2">
          Reserved via <span className="text-mid font-normal">(optional)</span>
        </label>
      ...
      <div>
        <label className="block text-sm font-semibold text-charcoal mb-1">
          Confirmation number <span className="text-mid font-normal">(optional)</span>
        </label>
        <input
          type="text"
